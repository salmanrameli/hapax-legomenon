    ...
    return (
        <Col className="col-12">
            <div className="d-flex gap-2 flex-wrap justify-content-center p-3 border-hapax-secondary hapax-box-shadow rounded-4">
                <h1><Spinner animation="border" className="spinner-orange" style={{ width: '3rem', height: '3rem', borderWidth: '0.3em', cursor:"pointer" }} /> Transforming text{props.totalTexts > 1 ? "s" : ""} to tokens</h1>
                <div className="w-100">

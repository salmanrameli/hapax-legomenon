    ...
    return (
        <Col className="col-12">
            <div className="d-flex gap-2 flex-wrap justify-content-center p-3 border border-dark border-3">
                ...
                <div className="w-100">
                    <ProgressBar animated className="w-100 rounded-0 border border-dark border-2" variant="warning" style={{ height: '20px', backgroundColor: '#fff' }} now={(props.countProcessedTexts / props.totalTexts) * 100} />
                </div>
            </div>
        </Col>
    )

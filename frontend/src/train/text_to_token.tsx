...
function TextToToken(props: ITextToToken) {
    return (
        <Col className="col-12">
            <div className="d-flex gap-2 flex-wrap justify-content-center p-3 border-hapax-secondary hapax-box-shadow rounded-4" style={{cursor:"default"}}>
                <h1 className="text-hapax-primary d-inline-flex"><Spinner animation="grow" className="spinner-orange me-3" style={{ width: '3rem', height: '3rem', borderWidth: '0.3em', cursor:"default" }} /> Transforming text{props.totalTexts > 1 ? "s" : ""} to tokens</h1>
                <div className="w-100">
